...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Register Don !', 'success')
            return redirect('home:home')
        return render(request, self.templates_name, {'form': form})
...
class UserLoginView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if user is not None:
                login(request, user)
                messages.success(request, 'You Are Logged in site', 'success')
                return redirect('home:home')
...
class UserProfileView(LoginRequiredMixin, View):
    def get(self, request, user_id):
        ...
        return render(request, 'accounts/profile.html', {'user': user, 'post': post})
